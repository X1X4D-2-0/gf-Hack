...
for xd in range(3005):
    ...
    uas.append(ff)
for JISAN in range(9993,176281):
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/Hridoykhan104/game.py/main/game.txt').text
...
$$    $$/ / $$   |$$    $$/ $$ |  $$ |$$ | $$$ |      
 $$$$$$/  $$$$$$/  $$$$$$/  $$/   $$/ $$/   $$/       
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : It'z Jisan Xhowdhury            
    │ [✓] GITHUB   : Itz-jisan            
    │ [✓] WHATSAPP : +8801814649133             
    │ [✓] VERSION  : 1.7.8                                    
    │ [✓] TOOLS    : \033[1;32m GF / BF HACK  \033[1;37m│
    └───────────────────────────────────────┘""")
  print(f"\033[1;32m FIRST GET APPROVEL")
  print(f"")
...
logo=(f"""\x1b[1;97m
\033[1;32m     _____  ______   ______    ______   __    __       
\033[1;32m    /     |/      | /      \  /      \ /  \  /  |      
\033[1;32m    $$$$$ |$$$$$$/ /$$$$$$  |/$$$$$$  |$$  \ $$ |      
\033[1;32m       $$ |  $$ |  $$ \__$$/ $$ |__$$ |$$$  \$$ |      
\033[1;32m  __   $$ |  $$ |  $$      \ $$    $$ |$$$$  $$ |      
...
\033[1;32m  $$$$$$/  $$$$$$/  $$$$$$/  $$/   $$/ $$/   $$/       
\033[1;32m    ┌───────────────────────────────────────┐
\033[1;32m    │ [✓] AUTHOR   : It'z Jisan Xhowdhury         
\033[1;32m    │ [✓] GITHUB   : Itz-jisan          
\033[1;32m    │ [✓] WHATSAPP : +8801814649133      
\033[1;32m    │ [✓] VERSION  : 1.7.8                                 
\033[1;32m    │ [✓] TOOLS    : \033[1;32m GF / BF HACK  \033[1;37m│
\033[1;32m    └───────────────────────────────────────┘""")
...
def Main():
    ...
    print(logo)
    print(50*'_')
    print("\033[1;35m [1] GF HACK 😍 \033[0m")
    print("\033[1;34m [2] BF HACK 😚 \033[0m")
